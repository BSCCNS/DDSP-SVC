...
from diffusion.vocoder import Vocoder, Unit2Mel, Unit2Wav, Unit2WavFast, Unit2WavPINN
...
if __name__ == '__main__':
    ...
    if args.model.type == 'Diffusion':
        ...
        from diffusion.solver_pinn import train
        model = Unit2WavPINN(
                args.data.sampling_rate,
                args.data.block_size,
                args.model.win_length,
                ...
                args.model.n_layers,
                args.model.n_chans,
                args.model.physical_dimensions)                   
    else:
